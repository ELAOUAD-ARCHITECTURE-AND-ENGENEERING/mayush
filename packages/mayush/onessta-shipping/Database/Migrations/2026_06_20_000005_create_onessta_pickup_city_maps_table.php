...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('onessta_pickup_city_maps')) {
            Schema::create('onessta_pickup_city_maps', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('onessta_pickup_city_maps');
    }
};
