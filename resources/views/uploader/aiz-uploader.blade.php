		...
		<div class="modal-content h-100">
					...
					<div class="tab-pane active h-100" id="aiz-select-file">
						<div class="aiz-uploader-filter pt-1 pb-3 border-bottom mb-4">
							...
							<div class="mt-2 text-muted fs-12">
								<small><i class="las la-info-circle"></i> {{ translate('Hold CTRL key to select multiple images simultaneously') }}</small>
							</div>
						</div>
			...
			<div class="modal-footer justify-content-between bg-light">
                ...
                <div class="d-flex align-items-center">
                    <div id="modal-bulk-delete-spinner" class="d-none mr-2">
                        <i class="las la-spinner la-spin"></i>
                    </div>
                    <button type="button" class="btn btn-sm btn-danger mr-2 d-none" id="uploader_bulk_delete_btn" onclick="AIZ.uploader.bulkDelete(event)">{{ translate('Delete Selection') }}</button>
...
<div id="aizUploaderDelete" class="modal fade" id="delete-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <p class="mt-1 fs-14">{{translate('Are you sure you want to delete this file?')}}</p>
                <button type="button" class="btn btn-link mt-2" data-dismiss="modal">{{translate('Cancel')}}</button>
                <button type="submit" class="btn btn-primary mt-2 aiz-uploader-confirmed-delete">{{translate('Delete')}}</button>
            </div>
        </div>
    </div>
</div>
