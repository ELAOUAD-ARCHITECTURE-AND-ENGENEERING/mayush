    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-corner-8px">
            ...
            <div class="modal-body pt-3 pb-30px px-3 px-lg-5">
                ...
                <div>
                    <p class="fs-14 fw-200 text-dark text-center bulk-delete-msg">{{ translate('Are you sure to delete those?') }}</p>
                    <div class="text-center d-none" id="bulk-delete-spinner">
                        <i class="las la-spinner la-spin la-3x opacity-70"></i>
                        <p class="mt-2">{{ translate('Deleting files, please wait...') }}</p>
                    </div>
                </div>
            </div>
            <!--Button-->
