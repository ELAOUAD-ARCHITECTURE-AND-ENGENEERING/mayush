...
@section('panel_content')
    <style>
        .seller-dashboard {
            --seller-primary: #0891B2;
            --seller-primary-strong: #164E63;
            --seller-accent: #06B6D4;
            --seller-success: #10B981;
            --seller-surface: #ECFEFF;
            --seller-border: #CFFAFE;
            --seller-text: #164E63;
        ...
        .seller-dashboard-header {
            ...
            padding: 16px 18px;
            margin: 8px 0 16px;
            box-shadow: 0 10px 24px rgba(46, 41, 78, 0.06);
        }

        .seller-dashboard-eyebrow {
            display: block;
            color: #7D7899;
            font-size: 12px;
            font-weight: 600;
        ...
        .seller-dashboard > .row > [class*="col-"] {
            padding-left: 8px;
            padding-right: 8px;
        }
        ...
        .seller-dashboard .card {
            border: 1px solid var(--seller-border);
            border-radius: 8px;
            box-shadow: 0 8px 22px rgba(46, 41, 78, 0.055) !important;
        ...
        .seller-dashboard .text-primary,
        .seller-dashboard .card-title {
            color: var(--seller-primary) !important;
        }

        .seller-dashboard .btn-primary,
        .seller-dashboard .bg-primary {
            background-color: var(--seller-primary) !important;
            border-color: var(--seller-primary) !important;
        }

        .seller-dashboard .btn-primary:hover {
            background-color: var(--seller-primary-strong) !important;
            border-color: var(--seller-primary-strong) !important;
        }

        .seller-dashboard .bg-soft-primary {
            background-color: var(--seller-surface) !important;
        }

        .seller-kpi-row .card.bg-primary {
            background: linear-gradient(135deg, var(--seller-primary-strong) 0%, var(--seller-primary) 68%, #0E7490 100%) !important;
            min-height: 112px;
        }

        .seller-kpi-row .card-body {
            padding: 16px 20px;
        }
        ...
        .seller-kpi-row .la-3x {
            font-size: 34px !important;
        }

        .seller-dashboard .h-450px {
            height: auto !important;
            min-height: 260px;
        }

        .seller-dashboard .h-180px {
            height: 140px !important;
        }

        .seller-dashboard .p-5 {
            padding: 24px !important;
        }

        .seller-dashboard .p-4 {
            padding: 18px !important;
        }

        .seller-dashboard .py-4 {
        ...
        .seller-dashboard .aiz-carousel .h-210px {
            height: 160px !important;
        }

        .seller-dashboard .aiz-card-box {
            border-color: var(--seller-border) !important;
            border-radius: 8px !important;
        }

        .seller-dashboard img[src*="verified.png"],
        .seller-dashboard img[src*="non_verified.png"] {
            max-width: 145px;
            height: auto;
        }

        .seller-dashboard .badge-soft-warning {
    ...
    <div class="seller-dashboard-header">
        <span class="seller-dashboard-eyebrow">{{ translate('Seller workspace') }}</span>
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-4">
                                ...
                                <g id="Group_23742" data-name="Group 23742" transform="translate(2044 3467)">
                                    ...
                                    <g id="Group_23741" data-name="Group 23741" transform="translate(310 759)">
                                        <path id="Path_26908" data-name="Path 26908"
                                            ...
                                            transform="translate(-2351 -4226)" fill="#0891B2" />
                                        <path id="Path_26909" data-name="Path 26909"
                                            ...
                                            transform="translate(-2491.298 -4498.774)" fill="#0891B2" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #0891B2">
                                ...
                                <g id="Group_23751" data-name="Group 23751" transform="translate(0 0.001)">
                                    <g id="Group_23750" data-name="Group 23750" transform="translate(0 -0.001)"
                                        ...
                                        <path id="Path_27505" data-name="Path 27505"
                                            ...
                                            transform="translate(0 0)" fill="#0891B2" />
                                        <path id="Path_27506" data-name="Path 27506"
                                            ...
                                            transform="translate(-174.22 -84.719)" fill="#0891B2" />
                                        <path id="Path_27507" data-name="Path 27507"
                                            ...
                                            transform="translate(-227.869 -227.867)" fill="#0891B2" />
                                        <path id="Path_27508" data-name="Path 27508"
                                            ...
                                            transform="translate(-307.867 -307.756)" fill="#0891B2" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                                ...
                                <g id="Group_23745" data-name="Group 23745" transform="translate(1901 3455)">
                                    ...
                                    <g id="Group_23744" data-name="Group 23744" transform="translate(-867.487 654.098)">
                                        ...
                                        <path id="Path_26914" data-name="Path 26914"
                                            ...
                                            transform="translate(-2536.278 -4319.726)" fill="#0891B2" />
                                        <path id="Path_26915" data-name="Path 26915"
                                            ...
                                            transform="translate(-2493.036 -4255.966)" fill="#0891B2" />
                                ...
                                <g id="Group_23747" data-name="Group 23747" transform="translate(1894 3457)">
                                    ...
                                    <g id="Group_23746" data-name="Group 23746" transform="translate(-1599.983 686.845)">
                                        ...
                                        <path id="Path_26919" data-name="Path 26919"
                                            ...
                                            transform="translate(-2557.593 -4432.681)" fill="#0891B2" />
                                        <path id="Path_26920" data-name="Path 26920"
                                            ...
                                            transform="translate(-2626.31 -4518.65)" fill="#0891B2" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                ...
                <div class="m-3">
                    <svg id="Group_22725" data-name="Group 22725" xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                        ...
                        <path id="Path_110"
                            ...
                            fill="#0891B2" />
                        <path id="Path_111" d="M28.5,21h-9a4.5,4.5,0,0,0,9,0" fill="#0891B2" />
                    </svg>
                </div>
            </a>
        </div>
                ...
                <div class=" m-3">
                    <svg id="Group_30" data-name="Group 30" xmlns="http://www.w3.org/2000/svg" width="31.999" height="32"
                        ...
                        <path id="Path_83" data-name="Path 83"
                            ...
                            transform="translate(-92.946 -10)" fill="#0891B2" />
