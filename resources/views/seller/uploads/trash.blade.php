...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		...
		<div class="col-md-6 text-md-right">
			<a href="{{ route('seller.uploaded-files.index') }}" class="btn btn-info">
	...
	<script type="text/javascript">
		...
		function bulk_restore() {
            ...
            $.ajax({
                ...
                url: "{{route('seller.uploaded-files.restore')}}",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
        ...
        function restore_single(id) {
            $.post("{{ route('seller.uploaded-files.restore') }}", {_token: AIZ.data.csrf, id: [id]}, function(data){
                if(data == 1){
        ...
        function bulk_force_delete() {
            ...
            $.ajax({
                ...
                url: "{{route('seller.uploaded-files.bulk-force-delete')}}",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
