...
@section('panel_content')
    ...
    <div class="row gutters-10 justify-content-center">
            ...
            <div class="col-md-4 mx-auto mb-3" >
                <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
                  ...
                  <div class="px-3 pt-3 pb-3">
                      <div class="h4 fw-700 text-center">{{ max(0, (auth()->user()->shop?->product_upload_limit ?? 0) - auth()->user()->products()->count()) }}</div>
        ...
        @if (addon_is_activated('seller_subscription'))
        @php
            $seller_package = auth()->user()->shop?->seller_package_id ? \App\Models\SellerPackage::find(auth()->user()->shop->seller_package_id) : null;
        @endphp
        <div class="col-md-4">
                    ...
                    <tbody>
                        @if(isset($products))
                            ...
                            <tr>
                                ...
                                <form action="{{ route('seller.products.destroy', $product->id) }}" method="POST" class="d-inline-block">
                                    @csrf
                                    @method('DELETE')
