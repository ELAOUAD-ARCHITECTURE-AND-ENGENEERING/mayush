    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-body p-0">
                    ...
                    @foreach (get_all_active_language() as $key => $language)
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3"
                                href="{{ route('seller.note.edit', ['note' => $note->id, 'lang' => $language->code]) }}">
                ...
                <form class="p-4" action="{{ route('seller.note.update', $note->id) }}" method="POST"
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-from-label">
                            {{ translate('Description') }} <small>({{ translate('Max 900 Character') }})</small> <i class="las la-language text-danger" title="{{ translate('Translatable') }}"></i>
