    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-body p-0">
                    ...
                    @foreach (get_all_active_language() as $key => $language)
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3"
                                href="{{ route('preorder-notification-types.edit', ['preorder_notification_type' => $notificationType->id, 'lang' => $language->code]) }}">
                ...
                <form class="p-4" action="{{ route('preorder-notification-types.update', $notificationType->id) }}" method="POST"
