            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <ul class="nav nav-tabs nav-fill language-bar">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3" href="{{ route('preorder-product.edit', ['preorder_product' => $product->id, 'lang' => $language->code]) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" style="display: none">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="min_qty"  min="1" step="1" value="{{$product->min_qty}}" required>
