                        ...
                        <div class="row ml-0">
                            ...
                            <div class="col-lg-2">
                                <select class="form-control form-control-sm aiz-selectpicker" name="type" onchange="sort_products()">
                                    ...
                                    <option value="unit_price,desc" @if(isset($col_name) && isset($query)) @if($col_name == 'unit_price' && $query == 'desc') selected @endif @endif>{{translate('Base Price (High > Low)')}}</option>
                                    <option value="unit_price,asc" @if(isset($col_name) && isset($query)) @if($col_name == 'unit_price' && $query == 'asc') selected @endif @endif>{{translate('Base Price (Low > High)')}}</option>
                                </select>
                            </div>
                            <div class="col-lg-4">
                    ...
                    <tbody>
                        @if(isset($products))
                            ...
                            <tr>
                                ...
                                @else
                                    <td>
                                        @if(isset($products) && method_exists($products, 'currentPage'))
                                ...
                                <td>
                                    <div class="row gutters-5 ">
                                        <div class="col-auto">
                                            <img src="{{ uploaded_asset($product->thumbnail) }}" alt="{{ translate('Image') }}" class="size-50px img-fit">
                                        </div>
                                    </div>
                                </td>
                                <td>
