...
<div class="card">
    <form class="" action="" id="sort_orders" method="GET">
        <div class="mx-4 mt-4">
            ...
            <div class="row">
                @if($routeName == 'seller.all_preorder.list')
                    <div class="col-12 mt-4">
                        <div class="badges ">
                            @php
                                $activeClasss = 'p-3 m-2 text-white rounded-3 fs-12 bg-primary';
                                $inActiveClasses = 'preorder-badge-border-dashed p-3 m-2 rounded-3';
                            @endphp
            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('seller.preorder-order.show', encrypt($order->id)) }}"
