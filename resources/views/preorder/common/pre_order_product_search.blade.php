                ...
                <div class="from-group row align-items-center">
                  <div class="col-auto">
                    <label class="aiz-checkbox">
                      <input type="checkbox" class="check-one" name="pre_order_product_id" value="{{ $product->id }}">
                      <span class="aiz-square-check"></span>
                    </label>
                    <img class="size-48px img-fit" src="{{ uploaded_asset($product->thumbnail)}}">
                  </div>
                  <div class="col">
                    <span>{{ $product->getTranslation('product_name')  }}</span>
                  </div>
                </div>
              </td>
