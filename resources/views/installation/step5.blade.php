            ...
            <div class="card install-card position-relative">
                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                    ...
                    <div class="mar-ver pad-btm text-center">
                        ...
                        <h1 class="fs-21 fw-700 text-uppercase mt-2" style="color: #3d3d3d;">{{ translate('Active eCommerce CMS Settings') }}</h1>
                        <p class="fs-12 fw-500" style="color:  #666; line-height: 18px;">{{ translate('Fill this form with basic information & admin login credentials') }}</p>
                    </div>

                    <form method="POST" action="{{ (Route::has('system_settings') ? route('system_settings') : '#') }}">
                        @csrf
                        <div class="form-group">
                            <label for="admin_name" class="fs-12 fw-500" style="color: #666;">{{ translate('Admin Name') }}</label>
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="admin_name" name="admin_name" required>
                        </div>

                        <div class="form-group">
                            <label for="admin_email" class="fs-12 fw-500" style="color: #666;">{{ translate('Admin Email') }}</label>
                        ...
                        <div class="form-group">
                            <label for="admin_password" class="fs-12 fw-500" style="color: #666;">{{ translate('Admin Password (At least 6 characters)') }}</label>
                        ...
                        <div class="form-group">
                            <label for="admin_name" class="fs-12 fw-500" style="color: #666;">{{ translate('System Currency') }}</label>
