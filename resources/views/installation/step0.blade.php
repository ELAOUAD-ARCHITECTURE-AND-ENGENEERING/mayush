            ...
            <div class="card install-card position-relative">
                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                    ...
                    <div class="mar-ver pad-btm text-center">
                        ...
                        <h1 class="fs-21 fw-700 text-uppercase mt-2" style="color: #3d3d3d;">{{ translate('ACTIVE ECOMMERCE CMS INSTALLATION') }}</h1>
                        <p class="fs-12 fw-500" style="color:  #fe2b25; line-height: 18px;">{{ translate('You will need to know the following items before proceeding') }}</p>
                    </div>
                    ...
                    <div class="d-flex mt-3">
                        ...
                        <p class="ml-2 mb-0 fs-12 fw-500" style="color: #666; line-height: 18px;">
                            {{ translate('During the installation process, we will check if the files that are needed to be written (.env file) have write permission. We will also check if curl are enabled on your server or not.') }}
                        </p>
                    </div>
                    <div class="d-flex mt-3">
                        <div>
                    ...
                    <div class="mb-4 pb-4 absolute-bottom-left right-0 d-flex justify-content-center">
                        <a href="{{ (Route::has('step1') ? route('step1') : '#') }}" class="btn btn-install text-uppercase">
                            {{ translate('Start Installation Process') }}
                        </a>
                    </div>
                </div>
