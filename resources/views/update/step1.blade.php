                  ...
                  <!-- Top content -->
                    <div class="mar-ver pad-btm text-center">
                        ...
                        <p class="fs-12 fw-500" style="color:  #666; line-height: 18px;">
                            {{ translate('Provide your codecanyon purchase code.') }}<br>
                    ...
                    <form method="POST" action="{{ (Route::has('update.code') ? route('update.code') : '#') }}">
                        @csrf
                        ...
                        <div class="mb-4 pb-4 absolute-bottom-left right-0 d-flex justify-content-center">
                          ...
                          <button type="submit" class="btn btn-install text-uppercase">{{ translate('Update') }}</button>
                        </div>
                    </form>
                </div>
