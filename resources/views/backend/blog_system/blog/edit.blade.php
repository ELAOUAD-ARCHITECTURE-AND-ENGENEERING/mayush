...
@section('content')
<form id="add_form" action="{{ route('blog.update', $blog->id) }}" method="POST">
    @csrf
    @method('PATCH')
    ...
    <div class="sticky-top-bar">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <h5 class="mb-0 h6 mr-3">{{ translate('Edit Article') }}</h5>
        ...
        <div class="col-lg-8">
            <div class="editor-container mb-4">
                <div class="form-group mb-4">
                    <input type="text" placeholder="{{translate('Article Title...')}}" onkeyup="makeSlug(this.value)" id="title" name="title" value="{{ $blog->title }}" class="form-control form-control-lg border-0 px-0" style="font-size: 2rem; font-weight: 700; background: transparent; box-shadow: none;" required>
                </div>
                ...
                <div class="form-group mb-4">
                    <div class="input-group">
                        ...
                        <input type="text" placeholder="{{translate('slug-will-be-here')}}" name="slug" id="slug" value="{{ $blog->slug }}" class="form-control border-0 bg-light" required>
                    </div>
                </div>

                <div class="form-group mb-4">
                    <label class="font-weight-bold">{{translate('Short Description')}} <span class="text-danger">*</span></label>
                    <textarea name="short_description" rows="3" class="form-control" placeholder="{{translate('A brief summary of the article...')}}" required="">{{ $blog->short_description }}</textarea>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="sidebar-section">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control aiz-selectpicker" name="category_id" id="category_id" data-live-search="true" required @if($blog->category != null) data-selected="{{ $blog->category->id }}" @endif>
            ...
            <div class="sidebar-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="meta_description" rows="3" class="form-control">{{ $blog->meta_description }}</textarea>
                </div>

                <div class="form-group">
                    <label>{{translate('Meta Keywords')}}</label>
                    <input type="text" class="form-control" name="meta_keywords" value="{{ $blog->meta_keywords }}" placeholder="{{translate('keyword1, keyword2')}}">
                </div>
