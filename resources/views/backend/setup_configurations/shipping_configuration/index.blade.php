    ...
    <div class="col-lg-8">
        ...
        <div class="card">
            <div class="{{ get_setting('shipping_type') == 'product_wise_shipping' ? 'border border-primary border-2 rounded-2' : '' }}">
                ...
                <div class="card-body">
                    <span>{{ translate('To set a product-wise shipping cost, please edit the desired product from the product edit page. You can access your product list') }} <a href="{{route('products.all')}}">{{ translate('here') }}</a></span>
                </div>
            </div>
        </div>
