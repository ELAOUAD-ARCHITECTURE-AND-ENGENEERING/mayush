                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                           <select class="form-control aiz-selectpicker" name="RECAPTCHA_SCORE_THRESHOLD" id="accept-v3-score" data-live-search="true">
                                ...
                                <option value="0.3" {{ env('RECAPTCHA_SCORE_THRESHOLD') == '0.3' ? 'selected' : '' }}>{{ translate('More than or equal to 0.3') }}</option>
                                <option value="0.5" {{ env('RECAPTCHA_SCORE_THRESHOLD') == '0.5' ? 'selected' : '' }}>{{ translate('More than or equal to 0.5') }}</option>
                                <option value="0.7" {{ env('RECAPTCHA_SCORE_THRESHOLD') == '0.7' ? 'selected' : '' }}>{{ translate('More than or equal to 0.7') }}</option>
                                <option value="0.9" {{ env('RECAPTCHA_SCORE_THRESHOLD') == '0.9' ? 'selected' : '' }}>{{ translate('More than or equal to 0.9') }}</option>
                            </select>
            ...
            <div class="card-body">
                <ul class="list-group">
                    <li class="list-group-item">
                        1. Score: 0.0 - 0.3 : <strong>{{ translate('Very likely a bot') }}</strong> — {{ translate('Recommended Action:') }} {{ translate('Block the request or require additional verification.') }}
                    </li>
                    <li class="list-group-item">
                        2. Score: 0.3 - 0.5 : <strong>{{ translate('Suspicious activity') }}</strong> — {{ translate('Recommended Action:') }} {{ translate('Might want to require additional verification.') }}
                    </li>
                    <li class="list-group-item">
                        3. Score: 0.5 - 0.7 : <strong>{{ translate('Possibly human') }}</strong> — {{ translate('Recommended Action:') }} {{ translate('Could be legitimate traffic.') }}
                    </li>
                    <li class="list-group-item">
                        4. Score: 0.7 - 0.9 : <strong>{{ translate('Likely human') }}</strong> — {{ translate('Recommended Action:') }} {{ translate('Probably safe to allow.') }}
                    </li>
                    <li class="list-group-item">
                        5. Score: 0.9 - 1.0 : <strong>{{ translate('Very likely human') }}</strong> — {{ translate('Recommended Action:') }} {{ translate('Definitely safe to allow.') }}
                    </li>
                    <li class="list-group-item">
