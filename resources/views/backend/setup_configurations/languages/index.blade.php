    ...
    <div class="col-lg-6">
        <div class="alert  alert-info mb-1 pb-0">
            ...
            <ul>
                ...
                <li class="py-0">{{ translate('Enter the') }} <strong>{{ translate('Language Name') }}</strong>, <strong>{{ translate('Language Code') }}</strong> {{ translate('(short form), and') }} <strong>{{ translate('Flutter App Lang Code') }}</strong>.</li>
            ...
            <ul class="pb-1 mb-3">
                <li class="py-0">{{ translate('Click the') }} <strong>{{ translate('“Translation”') }}</strong> {{ translate('option next to the language you want to edit.') }}</li>
                <li class="py-0">{{ translate('On the Translation page,') }} <strong>{{ translate('“Translate By Google”') }}</strong> {{ translate('button to automatically translate your website content.') }}</li>
                <li class="py-0">{{ translate('To sync translations for the mobile app, click') }} <strong>{{ translate('“Sync Translation For App”') }}</strong>.</li>
                <li class="py-0">{{ translate('To export the translation file, click') }} <strong>{{ translate('“Export arb File”') }}</strong>.</li>
