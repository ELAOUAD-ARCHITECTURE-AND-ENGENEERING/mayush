...
@section('content')
        ...
        <div class="aiz-titlebar text-left mt-2 mb-3">
            ...
            <div class="my-2 text-left">
                ...
                @endif
                <a class="btn btn-soft-info   btn-sm" href="{{(Route::has('app-translations.sync') ? route('app-translations.sync', $language->id) : '#')}}" title="{{ translate('All translaion will copy for app') }}">
