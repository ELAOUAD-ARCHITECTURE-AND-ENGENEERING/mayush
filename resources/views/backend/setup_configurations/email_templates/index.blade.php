                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                        href="{{ (Route::has('email-templates.edit') ? route('email-templates.edit', $emailTemplate->id) : '#') }}"
...
@section('script')
    <script type="text/javascript">
        ...
        function update_status(el) {
            ...
            $.post('{{ (Route::has('email-template.update-status') ? route('email-template.update-status') : '#') }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                status: status
            }, function(data) {
