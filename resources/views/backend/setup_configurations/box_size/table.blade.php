    ...
    <table class="table mb-0" id="aiz-data-table">
        <thead>
            <tr>
                ...
                <th class="hide-lg text-uppercase fs-10 fs-md-12 fw-700 text-secondary ml-1 ml-lg-0">
                    {{ translate('Length') }}
                </th>
        ...
        <tbody>
            @foreach ($shipping_box_sizes as $key => $shipping_box_size)
                <tr class="data-row">
                    ...
                    <td class="" data-label="{{ translate('Courier Type') }}">
                        <div class="row gutters-5 w-200px w-md-200px mw-200">
                            <div class="col">
                                <span
                                    class="text-dark fs-14 fw-300">{{ ucfirst( $shipping_box_size->courier_type )}}</span>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="hide-lg" data-label="{{ translate('Length') }}">
                        <div class="row gutters-5 w-200px w-md-200px mw-200">
                            <div class="col">
                                <span
                                    class="text-dark fs-14 fw-300">{{ $shipping_box_size->length }} cm</span>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="hide-xs" data-label="{{ translate('Breadth') }}">
                        <div class="row gutters-5 w-200px w-md-200px mw-200">
                            <div class="col">
                                <span
                                    class="text-dark fs-14 fw-300">{{ $shipping_box_size->breadth }} cm</span>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="hide-lg" data-label="{{ translate('Height') }}">
                        <div class="row gutters-5 w-200px w-md-200px mw-200">
                            <div class="col">
                                <span
                                    class="text-dark fs-14 fw-300">{{ $shipping_box_size->height }} cm</span>
                            </div>
                        </div>
                    </td>
                    @canany(['shipping_box_size_edit','shipping_box_size_delete'])
                                ...
                                <div class="dropdown float-right">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                        <div class="table-options">
                                            <!--Edit-->
                                            @can('shipping_box_size_edit')
                                                <a href="{{ (Route::has('shipping_box_size.edit') ? route('shipping_box_size.edit', ['id' => $shipping_box_size->id, 'lang' => env('DEFAULT_LANGUAGE') : '#')]) }}"
                                            ...
                                            @can('shipping_box_size_delete')
                                                <a  href="javascript:void(0)"
                                                    class="d-flex align-items-center px-20px py-10px hov-bg-light hov-text-blue" onclick="singleDelete({{$shipping_box_size->id}})"
