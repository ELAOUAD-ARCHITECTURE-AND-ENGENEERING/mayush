            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap border-bottom  border-light px-25px">
                ...
                <div class="mb-3 mb-md-0">
                    @can('shipping_box_size_create')
                     <a href="{{ (Route::has('shipping_box_size.create') ? route('shipping_box_size.create') : '#') }}" class="position-relative overflow-hidden add-new-btn">
    ...
    <script type="text/javascript">
        ...
        function sort_shipping_box_sizes(el){
         ...
         function single_delete(shippingBoxSizeId) {
            $.ajax({
                url: "{{ (Route::has('shipping_box_size.delete') ? route('shipping_box_size.delete', ':id') : '#') }}".replace(':id', shippingBoxSizeId),
                type: 'GET',
        ...
        function bulk_delete() {
            ...
            $.ajax({
                ...
                url: "{{(Route::has('bulk-shipping-box-sizes-delete') ? route('bulk-shipping-box-sizes-delete') : '#')}}",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
        ...
        function getShippingBoxSizes(slug, page = 1) {
            ...
            $.ajax({
                url: `{{ (Route::has('shipping_box_sizes.filter') ? route('shipping_box_sizes.filter' ) : '#') }}?page=${page}`,
                method: 'GET',
