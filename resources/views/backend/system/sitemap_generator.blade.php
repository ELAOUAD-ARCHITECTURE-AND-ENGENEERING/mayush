				...
				<div class="card-body">
					<form action="{{ route('generate_sitemap') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="base_url" class="form-control" placeholder="{{ translate('https://mayushdesign.com') }}" value="{{ rtrim(config('app.url'), '/') }}">
                        </div>
						<!-- Submit button -->
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <form action="{{ route('delete_sitemap') }}" method="post">
                                            ...
                                            <button class="btn btn-default btn-xs" type="submit" onclick="return confirm('{{ translate('Are you sure?') }}')" title="{{ translate('Delete File') }}"><i class="las la-2x la-trash-alt"></i></button>
                                        </form>
                                    </td>
                                    <td class="align-middle">
