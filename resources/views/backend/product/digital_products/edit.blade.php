            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <ul class="nav nav-tabs nav-fill language-bar" id="product-language-bar">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3" data-lang="{{ $language->code }}" href="{{ route('digitalproducts.edit', ['digitalproduct' => $product->id, 'lang' => $language->code]) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="meta_title"
                                    value="{{ $product->getTranslation('meta_title', $lang) }}" placeholder="{{ translate('Meta Title') }}">
                            </div>
                        </div>
                        <div class="form-group row">
...
<script type="text/javascript">
    ...
    function filterFqBoughtProduct() {
        ...
        $.post('{{ (Route::has('product.search') ? route('product.search') : '#') }}', { _token: AIZ.data.csrf, product_id: productID, search_key:searchKey, category:fqBroughCategory, product_type:"digital" }, function(data){
