    ...
    <div class="row align-items-center">
        ...
        @can('add_custom_review')
            <div class="col text-right">
                <a href="{{ (Route::has('custom-review.create') ? route('custom-review.create', null) : '#') }}" class="btn btn-sm rounded-2" style="background-color: #299395; color: white;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group mb-0 text-right">
                            <a href="{{ (Route::has('detail-reviews') ? route('detail-reviews', $product->id) : '#') }}" class="btn btn-primary btn-sm rounded-2">{{ translate('View Reviews') }}</a>
                        </div>
                    </td>
                </tr>
                @endforeach
