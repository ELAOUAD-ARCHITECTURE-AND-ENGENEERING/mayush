    ...
    <div class="row align-items-center">
        ...
        @can('add_custom_review')
            <div class="col text-right">
                <a href="{{ (Route::has('custom-review.create') ? route('custom-review.create', $product->id) : '#') }}" class="btn btn-sm rounded-2" style="background-color: #299395; color: white;">
...
<div class="card">
    <div class="d-flex justify-content-between">
        <div class="row gutters-5 w-400px w-md-500px align-items-center ml-1">
            <div class="col-auto">
                <img src="{{ uploaded_asset($product->thumbnail_img)}}" alt="{{ translate('Image') }}" class="size-80px img-fit">
            </div>
            <div class="col">
                    ...
                    @if($reviewType == 'custom')
                        <td class="text-right">
                            @can('edit_custom_review')
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{(Route::has('custom-review.edit') ? route('custom-review.edit', $review->id) : '#')}}" title="{{ translate('Edit') }}">
