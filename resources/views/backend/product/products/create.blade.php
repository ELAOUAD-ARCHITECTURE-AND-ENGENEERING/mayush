...
<script type="text/javascript">
    ...
    function filterFqBoughtProduct() {
        ...
        $.post('{{ (Route::has('product.search') ? route('product.search') : '#') }}', { _token: AIZ.data.csrf, product_id: null, search_key:searchKey, category:fqBroughCategory, product_type:"physical" }, function(data){
