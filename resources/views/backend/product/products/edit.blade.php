        ...
        <div class="flex-grow-1 p-sm-3 p-lg-2rem mb-2rem mb-md-0">
            ...
            <form action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" enctype="multipart/form-data" id="aizSubmitForm">
                ...
                <ul class="nav nav-tabs nav-fill language-bar" id="product-language-bar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3" data-lang="{{ $language->code }}" href="{{ route('products.admin.edit', ['id'=>$product->id, 'lang'=> $language->code] ) }}">
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <p>
                                    ...
                                    <a href="{{(Route::has('shipping_configuration.shipping_method') ? route('shipping_configuration.shipping_method') : '#')}}" class="aiz-side-nav-link {{ areActiveRoutes(['shipping_configuration.shipping_method'])}}">
...
<script type="text/javascript">
    ...
    function filterFqBoughtProduct() {
        ...
        $.post('{{ (Route::has('product.search') ? route('product.search') : '#') }}', { _token: AIZ.data.csrf, product_id: productID, search_key:searchKey, category:fqBroughCategory, product_type:"physical" }, function(data){
