										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="aiz-color-picker border-0 size-40px" type="color" value="{{ get_setting('flash_deal_section_outline_color') ?: '#000000' }}">
														</span>
													</div>
												</div>
											</div>
										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="aiz-color-picker border-0 size-40px" type="color" value="{{ get_setting('featured_section_bg_color') ?: '#000000' }}">
														</span>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="aiz-color-picker border-0 size-40px" type="color" value="{{ get_setting('featured_section_outline_color') ?: '#000000' }}">
														</span>
													</div>
												</div>
											</div>
										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="aiz-color-picker border-0 size-40px" type="color" value="{{ get_setting('best_selling_section_bg_color') ?: '#000000' }}">
														</span>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="aiz-color-picker border-0 size-40px" type="color" value="{{ get_setting('best_selling_section_outline_color') ?: '#000000' }}">
														</span>
													</div>
												</div>
											</div>
