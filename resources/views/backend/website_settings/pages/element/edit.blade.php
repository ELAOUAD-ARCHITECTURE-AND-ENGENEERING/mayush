    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-body p-0">
                    ...
                    @foreach (get_all_active_language() as $key => $language)
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3"
                                href="{{ route('elements.edit', ['element' => $element->id, 'lang' => $language->code]) }}">
                ...
                <form class="p-4" action="{{ route('elements.update', $element->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Name') }}" id="name" name="name"
                                class="form-control" required value="{{ $element->getTranslation('name', $lang) }}">
                        </div>
                    </div>
