                                    ...
                                    <td class="text-right">
                                        @can('delete_element_style')
                                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                                data-href="{{ (Route::has('destroy-element-style') ? route('destroy-element-style', $element_style->id) : '#') }}"
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ (Route::has('store-element-style') ? route('store-element-style') : '#') }}" method="POST">
                            @csrf
