                                    ...
                                    <td class="text-right">
                                        @can('view_element_styles')
                                            <a class="btn btn-soft-info btn-icon btn-circle btn-sm"
                                                href="{{ (Route::has('show-element-style') ? route('show-element-style', $element_type->id) : '#') }}"
                                        ...
                                        @can('edit_element_type')
                                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                                href="{{ (Route::has('edit-element-type') ? route('edit-element-type', ['id' => $element_type->id]) : '#') }}"
                                        ...
                                        @can('delete_element_type')
                                            <a href="#"
                                                ...
                                                data-href="{{ (Route::has('destroy-element-type') ? route('destroy-element-type', $element_type->id) : '#') }}"
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ (Route::has('store-element-type') ? route('store-element-type') : '#') }}" method="POST">
                            @csrf
