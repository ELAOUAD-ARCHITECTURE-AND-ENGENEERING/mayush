                    ...
                    <div class="row gutters-16">
                        ...
                        <div class="col-lg-4">
                            <div class="h-100 rounded-3 overflow-hideen">
                                <img class="w-100 custom-alert custom-alert-small d-none" src="{{ static_asset('assets/img/custom-alert-small.png') }}" alt="{{ translate('Custom alert small') }}">
                                <img class="w-100 custom-alert custom-alert-large d-none" src="{{ static_asset('assets/img/custom-alert-large.png') }}" alt="{{ translate('Custom alert large') }}">
                            </div>
                        </div>
                    </div>
                </div>
