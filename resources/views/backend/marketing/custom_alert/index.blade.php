        ...
        <div class="row">
                ...
                <label class="aiz-megabox mb-3">
                    ...
                    <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ static_asset('assets/img/alerts/alert-bottom-left.png') }}" class="h-100 w-100" alt="{{ translate('Alert') }}">
                        </div>
                    </span>
                </label>
                <br>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="aiz-megabox mb-3">
                    ...
                    <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ static_asset('assets/img/alerts/alert-bottom-right.png') }}" class="h-100 w-100" alt="{{ translate('Alert') }}">
                        </div>
                    </span>
                </label>
                <br>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="aiz-megabox mb-3">
                    ...
                    <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ static_asset('assets/img/alerts/alert-top-left.png') }}" class="h-100 w-100" alt="{{ translate('Alert') }}">
                        </div>
                    </span>
                </label>
                <br>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="aiz-megabox mb-3">
                    ...
                    <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ static_asset('assets/img/alerts/alert-top-right.png') }}" class="h-100 w-100" alt="{{ translate('Alert') }}">
                        </div>
                    </span>
                </label>
                <br>
                     ...
                     <tr>
                        ...
                        <td>
                            <div class="size-64px rounded-2 overflow-hidden">
                                <img class="h-100 img-fit" src="{{ static_asset('assets/img/placeholder.jpg') }}" alt="">
                            </div>
                        </td>
                        <td class="fs-13 fw-700"> {{translate('Product Title')}} - {{translate('ordered just now')}}  (<a href="{{ route('custom-sale-alert.edit') }}">{{translate('Custom sale alert')}}</a>)</td>
                        <td>#</td>
                        <td>
                        ...
                        <td>
                            <div class="dropdown float-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                    ...
                                    <a class="dropdown-item" href="{{route('custom-sale-alert.edit')}}">
                                        {{translate('Edit')}}
                                    </a>
                                    @endcan
                                </div>
