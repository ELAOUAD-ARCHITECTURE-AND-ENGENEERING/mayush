                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                        ...
                                        @endcan
                                        @if($shop->user->email_verified_at == null)
                                            <a href="{{route('sellers.email_verification_resend', $shop->id)}}" class="dropdown-item">
                                        ...
                                        @can('mark_seller_suspected')
                                            @if($shop->user->is_suspicious == 1)
                                                <a href="javascript:void();" onclick="confirm_suspicious('{{ Route::has('seller.suspicious') ? route('seller.suspicious', encrypt($shop->user->id)) : '#' }}', true);" class="dropdown-item">
                                                        {{ translate(" Mark as " . ($shop->user->is_suspicious == 1 ? 'unsuspect' : 'suspicious') . " ") }}
                                                </a>
                                            @else
                                                <a href="javascript:void();" onclick="confirm_suspicious('{{ Route::has('seller.suspicious') ? route('seller.suspicious', encrypt($shop->user->id)) : '#' }}', false);" class="dropdown-item">
                                                        {{ translate(" Mark as " . ($shop->user->is_suspicious == 1 ? 'unsuspect' : 'suspicious') . " ") }}
                                                </a>
                                            @endif
                                        @endcan
