            ...
            <div class="card-body p-0">
                ...
                <ul class="nav nav-tabs nav-fill language-bar">
                  @foreach (get_all_active_language() as $key => $language)
                    <li class="nav-item">
                      <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3" href="{{ route('customer_packages.edit', ['customer_package'=>$customer_package->id, 'lang'=> $language->code] ) }}">
