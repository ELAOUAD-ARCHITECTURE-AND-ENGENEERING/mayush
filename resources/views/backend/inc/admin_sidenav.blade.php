            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('admin.security_dashboard') }}" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text" style="color: #e74c3c; font-weight: bold;">{{translate('Security Overview')}}</span>
                        @php
                            $failed_logins = \App\Models\AuditLog::where('action_type', 'FAILED_LOGIN')->where('created_at', '>=', now()->subDay())->count();
                        @endphp
                        @if($failed_logins > 0)
                            <span class="badge badge-inline badge-danger">{{ $failed_logins }}</span>
                        @endif
                    </a>
                </li>
                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','add_digital_product','edit_digital_product','product_edit','product_bulk_import',
                        'product_bulk_export','view_product_categories','view_all_brands', 'brand_bulk_upload','view_product_attributes','view_colors','view_product_warranties', 'smart-bar', 'view_custom_label', 'view_product_reviews', 'view_product_collections', 'view_inspiration'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                            ...
                            @canany(['view_all_brands', 'brand_bulk_upload'])
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ (Route::has('brand_bulk_upload.index') ? route('brand_bulk_upload.index') : '#') }}" class="aiz-side-nav-link">
                ...
                <!-- Promotion & Offers -->
                @canany(['view_promotion_and_offers_dashboard', 'view_promotional_product', 'add_promotional_products'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <path d="M2 3.5A1.5 1.5 0 0 1 3.5 2h9A1.5 1.5 0 0 1 14 3.5v2.1a1.5 1.5 0 0 0 0 2.8v2.1a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 10.5V8.4a1.5 1.5 0 0 0 0-2.8V3.5Zm5 1a.5.5 0 0 0-1 0v1a.5.5 0 0 0 1 0v-1Zm0 3a.5.5 0 0 0-1 0v1a.5.5 0 0 0 1 0v-1Zm0 3a.5.5 0 0 0-1 0v1a.5.5 0 0 0 1 0v-1Z" fill="#575b6a"/>
                                </svg>
                            </div>
                            <span class="aiz-side-nav-text">{{ translate('Promotion & Offers') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_promotion_and_offers_dashboard')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('promotion_and_offers.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['promotion_and_offers.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Dashboard') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_promotional_product')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('promotional_products.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['promotional_products.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Promotional Products') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_promotional_product')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('todays_deal_products.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['todays_deal_products.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate("Today's Deal Products") }}</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('promotions.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['promotions.index']) }}">
                        <div class="aiz-side-nav-icon">
                            <i class="las la-bullhorn"></i>
                        </div>
                        <span class="aiz-side-nav-text">{{ translate('Promotions') }}</span>
                        @php
                            $pending_promotions = \App\Models\Promotion::where('status', 'awaiting_admin_review')->count();
                        @endphp
                        @if($pending_promotions > 0)
                            <span class="badge badge-inline badge-warning">{{ $pending_promotions }}</span>
                        @endif
                    </a>
                </li>
 ...
 <!-- Refund addon -->
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @can('view_classified_products')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('promotions.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Promotion Requests')}}</span>
                                @php
                                    $pending_promotions = \App\Models\Promotion::where('status', 'awaiting_admin_review')->count();
                                @endphp
                                @if($pending_promotions > 0)
                                    <span class="badge badge-inline badge-danger">{{ $pending_promotions }}</span>
                                @endif
                            </a>
                        </li>
                        @endcan
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ (Route::has('email-templates.index') ? route('email-templates.index', 'admin') : '#') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('Admin Templates')}}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ (Route::has('email-templates.index') ? route('email-templates.index', 'seller') : '#') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('Seller Templates')}}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ (Route::has('email-templates.index') ? route('email-templates.index', 'customer') : '#') }}"
                                        class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('Customer Templates')}}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ (Route::has('email-templates.index') ? route('email-templates.index', 'all') : '#') }}" class="aiz-side-nav-link">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ (Route::has('contacts.index') ? route('contacts.index') : '#') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['contacts.index']) }}">
                ...
                'business_settings','manage_ai_configuration'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('invoice.config') }}" class="aiz-side-nav-link {{ areActiveRoutes(['invoice.config']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Invoice Configuration') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('shipping.label') }}" class="aiz-side-nav-link {{ areActiveRoutes(['shipping.label']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Shipping Label') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('thermal.printer') }}" class="aiz-side-nav-link {{ areActiveRoutes(['thermal.printer']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Thermal Printer') }}</span>
                            </a>
                        </li>
                        @endcan
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="javascript:void(0);" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('AI Configuration') }}</span>
                                <span class="aiz-side-nav-arrow"></span>
                            </a>
                            <ul class="aiz-side-nav-list level-3">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('ai-config') }}" class="aiz-side-nav-link {{ areActiveRoutes(['ai-config']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Settings') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('ai-prompt-templates') }}" class="aiz-side-nav-link {{ areActiveRoutes(['ai-prompt-templates']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Prompt Templates') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('ai-product-generation') }}" class="aiz-side-nav-link {{ areActiveRoutes(['ai-product-generation']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Product Generation') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('ai-token-usage') }}" class="aiz-side-nav-link {{ areActiveRoutes(['ai-token-usage']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Token Usage') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('cloudflare_turnstile.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('Cloudflare Turnstile')}}</span>
                                    </a>
                                </li>
                                @endcan
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                @if (addon_is_activated('shiprocket'))
                                    @can('pickup_address_index')
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ (Route::has('pickup_address.index') ? route('pickup_address.index') : '#') }}" class="aiz-side-nav-link {{ areActiveRoutes(['pickup_address.index','pickup_address.create','pickup_address.edit'])}}">
                                    ...
                                    <li class="aiz-side-nav-item">
                                        <a href="{{(Route::has('shipping_box_size.index') ? route('shipping_box_size.index') : '#')}}"
