                        ...
                        <div>
                            ...
                            @if ($detailedProduct->digital ==0)
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    {{-- Stock Status Display Next to Quantity --}}
                                    @if ($qty == 0)
                                        <span class="ml-3 fs-14 fw-400 text-danger" style="font-style: italic;">
                                            {{ translate('En rupture de stock') }}
                                        </span>
                                    @elseif ($qty > 0 && $qty < 5)
                                        <span class="ml-3 fs-14 fw-400 text-warning" style="font-style: italic;">
                                            {{ translate('Almost Out of Stock') }} - {{ translate('Only') }} <span id="available-quantity">{{ $qty }}</span> {{ translate('Left!') }}
                                        </span>
                                    @elseif ($detailedProduct->stock_visibility_state == 'quantity')
                                        <span class="ml-3 fs-14 fw-400 text-success" style="font-style: italic;">
                                ...
                                <p class="m-0 mt-2 fs-12 fw-400 text-gray">{{translate('Minimum order qty')}} <span class="text-dark fw-700">{{ $detailedProduct->min_qty }}</span></p>
                            @endif
            ...
            <div class="row no-gutters mb-3">
                <div class="col-12 col-sm-12 mt-3">
                    <div class="product-quantity d-flex align-items-center">
                        <a type="button" class="text-white text-center border-0 rounded-1 fs-14 fw-bold bg-black hov-opacity-70 has-transition py-20px px-20px d-block w-100 mb-2 mb-md-0 mr-0 mr-md-2" href="">
