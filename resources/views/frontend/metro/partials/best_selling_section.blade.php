...
<div class="metro-collection-subsection">
    <div class="d-flex mb-2 mb-md-3 align-items-start justify-content-between">
        <div class="pr-3">
            <h2 class="fs-18 fs-md-24 fw-800 mb-1 text-dark">{{ translate("L’art de vivre commence chez vous") }}</h2>
            <h3 class="fs-13 fs-md-15 fw-400 text-muted mb-0 lh-1-6">
                {{ translate('Les meilleures ventes qui font la tendance cette saison.') }}
            </h3>
        </div>
