...
<div class="metro-collection-subsection">
    <div class="metro-collection-copy text-white">
        ...
        <div class="metro-collection-slider-nav">
            <a type="button" class="metro-collection-slider-arrow" onclick="clickToSlide('slick-prev','section_best_selling')" aria-label="{{ translate('Previous') }}">
                <i class="las la-angle-left"></i>
            </a>
            <a type="button" class="metro-collection-slider-arrow" onclick="clickToSlide('slick-next','section_best_selling')" aria-label="{{ translate('Next') }}">
