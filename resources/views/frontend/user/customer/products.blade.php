                ...
                <tbody class="fs-14">
                    ...
                    <tr>
                        ...
                        <td class="text-right pr-0" style="vertical-align: middle;">
                            <a href="javascript:void(0)" onclick="promote_product({{ $product->id }})" class="btn btn-soft-primary btn-icon btn-circle btn-sm hov-svg-white" title="{{ translate('Promote') }}">
                            ...
                            <form action="{{ route('customer_products.destroy', $product->id) }}" method="POST" class="d-inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-soft-danger btn-icon btn-circle btn-sm hov-svg-white" title="{{ translate('Delete') }}">
...
@section('modal')
    ...
    <!-- Promotion Modal -->
    <div class="modal fade" id="promotion_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ translate('Promote Product') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('customer_products.promote') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" name="product_id" id="promotion_product_id">
                        <div class="form-group">
                            <label>{{ translate('Promotion Tier') }}</label>
                            <select class="form-control aiz-selectpicker" name="tier">
                        ...
                        <div class="alert alert-info">
                            {{ translate('This will consume 1 upload credit.') }}
                        </div>
                    </div>
