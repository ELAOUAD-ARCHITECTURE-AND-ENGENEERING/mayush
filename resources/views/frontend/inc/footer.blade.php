    ...
    <div class="container">
        <div class="row align-items-center py-3">
            ...
            <div class="col-lg-7 order-1 order-lg-0">
                <div class="text-center text-lg-left fs-14 d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start" current-verison="{{get_setting("current_version")}}">
                    <span class="text-white">{!! get_setting('frontend_copyright_text', null, App::getLocale()) !!}</span>
                ...
                <div class="text-center text-lg-right">
                    <ul class="list-inline mb-0">
                        @if ( get_setting('payment_method_images') !=  null )
                            @php
                                $payment_methods = explode(',', get_setting('payment_method_images'));
                            @endphp
                            @foreach ($payment_methods as $key => $value)
                                <li class="list-inline-item mr-2">
                                    <img src="{{ uploaded_asset($value) }}" height="22" class="mw-100" style="max-height: 22px" alt="{{ translate('payment_method') }}">
                                </li>
                            @endforeach
                        @endif
                    </ul>
        ...
        <!-- Security & Payment Logos Section -->
        <div class="row align-items-center py-4 border-top" style="border-color: rgba(255,255,255,0.05) !important;">
            <div class="col-12">
