                            ...
                            <div class="card-body text-center px-4 pt-0">
                                <div class="row gutters-10">
                                    ...
                                    @if (get_setting('cmi_payment') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="cmi" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    ...
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('CMI') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            @if (Auth::check())
                                ...
                                <div class="mt-4 pt-4 border-top">
                                    <div class="text-center mb-3">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center flex-wrap">
                                            <img src="{{ optimized_static_asset('assets/img/cards/verified_by_visa.png', 'small') }}" width="56" height="25" class="mx-2 mb-2" alt="{{ translate('Verified by Visa') }}" style="max-height: 25px;">
                                            <img src="{{ optimized_static_asset('assets/img/cards/secure_code.png', 'small') }}" width="54" height="25" class="mx-2 mb-2" alt="{{ translate('Mastercard SecureCode') }}" style="max-height: 25px;">
                                            <img src="{{ optimized_static_asset('assets/img/cards/amex.png', 'small') }}" width="25" height="25" class="mx-2 mb-2" alt="{{ translate('American Express') }}" style="max-height: 25px;">
                                            <img src="{{ optimized_static_asset('assets/img/cards/cmi.png', 'small') }}" width="31" height="25" class="mx-2 mb-2" alt="{{ translate('CMI Payment Gateway') }}" style="max-height: 25px;">
                                            <img src="{{ optimized_static_asset('assets/img/cards/marocpay.png', 'small') }}" width="29" height="25" class="mx-2 mb-2" alt="{{ translate('MarocPay') }}" style="max-height: 25px;">
                                            <img src="{{ optimized_static_asset('assets/img/cards/unionpay.png', 'small') }}" width="36" height="25" class="mx-2 mb-2" alt="{{ translate('UnionPay') }}" style="max-height: 25px;">
                                        </div>
                                    </div>
                                </div>
