<!-- New Address Modal -->
<div class="modal fade premium-modal" id="new-billing-address-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form class="form-default" role="form" action="{{ (Route::has('billing_addresses.store') ? route('billing_addresses.store') : '#') }}" method="POST">
                @csrf
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control aiz-selectpicker rounded-0" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="billing_country_id" required>
                        ...
                        <div class="row billing-area-field d-none">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 aiz-selectpicker rounded-0" data-live-search="true" name="billing_area_id">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="tel" id="billing-phone-code" class="form-control rounded-0" placeholder="" name="billing_phone" autocomplete="off" required>
...
<!-- Edit Address Modal -->
<div class="modal fade premium-modal" id="edit-address-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
