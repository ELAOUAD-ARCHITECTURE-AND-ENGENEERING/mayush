                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="product-slider-wrapper mb-2rem mb-lg-0">
                            ...
                            <ul class="breadcrumb bg-transparent pt-0 px-0 pb-10px d-flex align-items-center">
                                ...
                                <li class="fs-12 fw-400 has-transition opacity-50 hov-opacity-100">
                                     {{translate($detailedProduct->main_category->name ?? '')}}
                                </li>
                                <i class="las la-angle-right fs-12 fw-600 text-gray hide_cat1"></i>
        ...
        <div class="product-details-nav-tab mb-5">
            ...
            <div class="container d-flex flex-column">
               ...
               <!--REVIEWS & RATINGS SECTION END-->
                ...
                <section id="smartRecommendations">
                    @include('frontend.product_details.parts.deals_on_related')
                    @include('frontend.product_details.parts.also_viewed')
                    @include('frontend.product_details.parts.category_best_sellers')
                    @include('frontend.product_details.parts.history_recommendations')
                </section>
                <!--SMART RECOMMENDATIONS END-->
                @endif
            </div>
        </div>
   ...
   <script type="text/javascript">
    ...
    //     });
        ...
        function showSizeChartDetail(id, name){
            ...
            $.ajax({
                type: "GET",
                url: "{{ (Route::has('size-charts-show') ? route('size-charts-show', '') : '#') }}/"+id,
                data: {},
