 ...
 <!-- Refund addon -->
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @can('view_refund_requests')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('refund_requests_all')}}" class="aiz-side-nav-link {{ areActiveRoutes(['refund_requests_all'])}}">
                                ...
                                @can('view_dispute_refund_requests')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('dispute_refund_requests_all')}}" class="aiz-side-nav-link {{ areActiveRoutes(['dispute_refund_requests_all'])}}">
                                            <span class="aiz-side-nav-text">{{translate('Dispute Refund Requests')}}</span>
                                        </a>
                                    </li>
                                @endcan
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('refund_reason_index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['refund_reason_index', 'refund_reason_create', 'refund_reason_edit'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Refund Reasons')}}</span>
                                    </a>
                                </li>
                                @endcan
                ...
                @canany(['view_promotion_and_offers_dashboard', 'view_all_flash_deals', 'todays_deal_products.index' , 'view_all_coupons', 'set_category_wise_discount', 'view_promotional_product'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="#666666"><path d="M160-80v-440H80v-240h208q-5-9-6.5-19t-1.5-21q0-50 35-85t85-35q23 0 43 8.5t37 23.5q17-16 37-24t43-8q50 0 85 35t35 85q0 11-2 20.5t-6 19.5h208v240h-80v440H160Zm371.5-748.5Q520-817 520-800t11.5 28.5Q543-760 560-760t28.5-11.5Q600-783 600-800t-11.5-28.5Q577-840 560-840t-28.5 11.5ZM360-800q0 17 11.5 28.5T400-760q17 0 28.5-11.5T440-800q0-17-11.5-28.5T400-840q-17 0-28.5 11.5T360-800ZM160-680v80h280v-80H160Zm280 520v-360H240v360h200Zm80 0h200v-360H520v360Zm280-440v-80H520v80h280Z"/></svg>
                            </div>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('promotional_products.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Promotional Product') }}</span>
                                </a>
                            </li>
                            @endcan
                            @can('view_all_flash_deals')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('flash_deals.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['flash_deals.index', 'flash_deals.create', 'flash_deals.edit'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Flash Sales') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_all_todays_deals')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('todays_deal_products.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate("Today's Deals") }}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            {{-- <li class="aiz-side-nav-item">
                                <a href="javascript:void(0);" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('BOGO')}}</span>
                                    <span class="aiz-side-nav-arrow"></span>
                                </a>
                                <ul class="aiz-side-nav-list level-3">
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('promotion_and_offers.all_bogo') }}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('All Bogo')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('promotion_and_offers.all_bogo_campaigns') }}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('All Bogo Campaigns')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('promotion_and_offers.bogo.create_bogo') }}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('Create New')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li> --}}
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('google-analytics-config') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Google Analytics (GA4)')}}</span>
                            </a>
                        </li>
                        @if (get_setting('google_analytics') == 1)
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('google-analytics-test.result') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Google Analytics Reports')}}</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('google-tag-manager-config') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Google TAG Manager')}}</span>
                            </a>
                        </li>
                        @endcan
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('pixel_analytics.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Meta Pixel')}}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('pixel_conversation_api.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Meta Conversion API')}}</span>
                            </a>
                        </li>
                        @endcan
                    </ul>
                        ...
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16" viewBox="0 0 16 16">
                                <defs>
                                    ...
                                    <path id="Path_3" data-name="Path 3" d="M0,0H16V16H0Z" fill="#beb8cc"/>
                                    </clipPath>
                                </defs>
                                <g id="Group_1" data-name="Group 1" clip-path="url(#clip-path)">
                                    <path id="Path_1" data-name="Path 1" d="M47.948,55.953h-2.4a1.8,1.8,0,0,0-1.8,1.8V65.33a1.8,1.8,0,0,0,1.8,1.8h7.575a1.8,1.8,0,0,0,1.8-1.8V62.159l1.082-.742v3.913a2.886,2.886,0,0,1-2.885,2.885H45.552a2.886,2.886,0,0,1-2.885-2.885V57.756a2.885,2.885,0,0,1,2.885-2.886h3.03Z" transform="translate(-41.334 -53.155)" fill="#beb8cc" fill-rule="evenodd"/>
                                    <path id="Path_2" data-name="Path 2" d="M256.718,0a.206.206,0,0,1,.2.164,4.667,4.667,0,0,0,1.267,2.323,4.667,4.667,0,0,0,2.323,1.267.2.2,0,0,1,0,.4,4.691,4.691,0,0,0-3.6,3.624.2.2,0,0,1-.384,0,4.691,4.691,0,0,0-3.631-3.631.2.2,0,0,1,0-.384,4.667,4.667,0,0,0,2.357-1.275A4.667,4.667,0,0,0,256.519.164a.205.205,0,0,1,.2-.164Z" transform="translate(-244.838 0)" fill="#beb8cc" fill-rule="evenodd"/>
                                </g>
                            </svg>


                        </div>
                        <span class="aiz-side-nav-text">{{ translate('AI Studio') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('ai-add_edit_products') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Add/Edit Product With AI')}}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        'view_all_offline_wallet_recharges','view_all_offline_customer_package_payments','view_all_offline_seller_package_payments', 'view_all_payout_method_for_customer'])
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                ...
                                @if (addon_is_activated('refund_request') && auth()->user()->can('view_all_payout_method_for_customer'))
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('payout_method_for_customer_index') }}"
                                            ...
                                            <span class="aiz-side-nav-text">{{translate('Offline Payout Methods')}}</span>
                                        </a>
                                    </li>
                                @endif
                            </ul>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('business_settings.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['general.info', 'order.config', 'invoice.config', 'order_tracking.config', 'shipping_label.config'])}}">
