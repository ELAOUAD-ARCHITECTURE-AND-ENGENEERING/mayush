...
export interface AuthenticationWelcomeScreenProps {
  onSignIn: () => void;
...
export const AuthenticationWelcomeScreen: React.FC<AuthenticationWelcomeScreenProps> = ({
  onSignIn,
  onCreateAccount,
  onContinueAsGuest,
  onTermsClick,
  ...
  <View style={styles.screen} accessibilityLabel="Bienvenue chez Mayush">
    ...
    <View style={styles.sheet}>
      <View style={styles.iconCircle}>
        <MayushIcon name="sofa" size={29} color={colors.brand.orange500} />
      </View>
      ...
      <MayushText variant="caption" color={colors.neutral.gray700} align="center" style={styles.subtitle}>
        Connectez-vous pour retrouver vos favoris, suivre vos commandes et acheter plus rapidement.
      </MayushText>
      <TouchableOpacity accessibilityRole="button" onPress={onSignIn} style={styles.primary}>
        <MayushIcon name="shield" size={18} color={colors.surface.white} />
        <MayushText variant="button" color={colors.surface.white}>Se connecter</MayushText>
      </TouchableOpacity>
      <TouchableOpacity accessibilityRole="button" onPress={onCreateAccount} style={styles.secondary}>
        <MayushIcon name="user" size={18} color={colors.brand.orange500} />
        <MayushText variant="button" color={colors.brand.orange500}>Créer un compte</MayushText>
      </TouchableOpacity>
      <View style={styles.or}>
        <View style={styles.orRule} />
        <MayushText variant="caption" color={colors.neutral.gray700}>ou</MayushText>
        <View style={styles.orRule} />
      </View>
      <TouchableOpacity accessibilityRole="button" onPress={onContinueAsGuest} style={styles.guest}>
        <MayushIcon name="user" size={18} color={colors.brand.navy900} />
        <MayushText variant="button" color={colors.brand.navy900}>Continuer en tant qu’invité</MayushText>
      </TouchableOpacity>
    </View>
    <TouchableOpacity onPress={onTermsClick} style={styles.legal} accessibilityRole="button">
      <MayushIcon name="shield" size={15} color={colors.brand.navy900} />
      <MayushText variant="caption" color={colors.brand.navy900}>Conditions d’utilisation</MayushText>
      <MayushText variant="caption" color={colors.neutral.gray700}>·</MayushText>
      <MayushText variant="caption" color={colors.brand.navy900}>Politique de confidentialité</MayushText>
    </TouchableOpacity>
  </View>
);
