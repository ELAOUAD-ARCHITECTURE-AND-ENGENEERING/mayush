...
(async () => {
  ...
  const suite = load(path.join(__dirname, '../tests/Step8B0OrderFoundationBehaviorTest.ts'));
  await suite.runStep8B0OrderFoundationBehaviorTests(assert);
  console.log(`STEP 8B.0 BEHAVIOR SUMMARY: ${passes} PASSED, ${failures} FAILED`);
