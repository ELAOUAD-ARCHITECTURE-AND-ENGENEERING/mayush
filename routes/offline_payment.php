...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user'], 'as' => 'seller.'], function () {
    ...
    Route::post('/offline-seller-package-paymnet',[SellerPackageController::class, 'purchase_package_offline'])->middleware(['throttle:payments'])->name('make_offline_payment');
});
