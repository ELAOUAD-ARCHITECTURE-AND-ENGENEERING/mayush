...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    Route::controller(ClubPointController::class)->group(function () {
        Route::get('club-points/configuration', [PointManagementController::class, 'templates'])->name('club_points.configs');
        ...
        Route::get('set-club-points', [PointManagementController::class, 'dashboard'])->name('set_product_points');
        ...
        Route::get('set-club-points/{id}', [PointManagementController::class, 'dashboard'])->name('product_club_point.edit');
...
Route::group(['middleware' => ['user', 'verified']], function(){
    Route::controller(ClubPointController::class)->group(function () {
        Route::get('earning-points', 'index')->name('earnng_point_for_user');
        Route::post('convert-point-into-wallet', 'convert_into_wallet')->name('convert_point_into_wallet');
    });
});
