    ...
    public function step0(Request $request)
    {
        ...
        if ($request->has('update_zip')) {
            if (class_exists('ZipArchive')) {
                ...
                //COMMENT FOR DEMO->
                $versions = ['9.9.5'=>'v995.sql', '9.9.6'=>'v996.sql','9.9.7'=>'v997.sql','9.9.8'=>'v998.sql','9.9.9'=>'v999.sql','10.0.0'=>'v1000.sql','10.1.0'=>'v1010.sql','10.2.0'=>'v1020.sql','10.2.1'=>'v1021.sql','10.2.2'=>'v1022.sql','10.3.0'=>'v1030.sql'];

                $keys = array_keys($versions);
                $current_version = (get_setting('current_version') != null) ? get_setting('current_version') : '9.9.5';
