...
class PosController extends Controller
{
    ...
    public function order_place(Request $request)
    {
        ...
        $order->seller_id = Auth::user()->id; // Admin ID
        $order->shipping_address = $combined_order->shipping_address;
        $order->payment_type = $request->payment_type;
        $order->payment_status = 'paid'; // POS orders are usually paid immediately
        $order->delivery_status = 'delivered'; // POS orders are delivered immediately
        ...
        // Process Affiliate and Club Points
