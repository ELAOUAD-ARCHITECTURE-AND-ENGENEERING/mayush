...
class CustomerController extends Controller
{
    ...
    {
        $sort_search = null;
        $users = User::where('user_type', 'customer')->whereNull('email_verified_at')->orderBy('created_at', 'desc');
        ...
        $users = $users->paginate(15);
        return view('backend.customer.customers.unverified', compact('users', 'sort_search'));
    }
}
