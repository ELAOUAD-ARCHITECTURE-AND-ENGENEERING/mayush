...
class CustomerProductController extends Controller
{
    ...
    {   
        ...
        if ($user->user_type == 'customer') {
            return response()->json([
                'result' => false,
                'message' => translate('Access Denied. Customers cannot create classified products.')
            ], 403);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($user->user_type == 'customer') {
            return response()->json([
                'result' => false,
                'message' => translate('Access Denied. Customers cannot update classified products.')
            ], 403);
        }
    ...
    public function delete($id)
    {
        ...
        if (auth()->user()->user_type == 'customer') {
            return response()->json([
                'result' => false,
                'message' => translate('Access Denied. Customers cannot delete classified products.')
            ], 403);
        }
    ...
    public function changeStatus(Request $req, $id)
    {
        ...
        if (auth()->user()->user_type == 'customer') {
            return response()->json([
                'result' => false,
                'message' => translate('Access Denied. Customers cannot change classified product status.')
            ], 403);
        }
